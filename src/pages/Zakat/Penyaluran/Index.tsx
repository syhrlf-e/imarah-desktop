...
interface PenyaluranTransaction {
    id: string;
...
export default function PenyaluranIndex() {
    ...
    const { data: res, isLoading } = usePenyaluranData(searchParams.toString());
        ...
        <AppLayout title="Penyaluran Zakat">
            <div className="contents">
                <PageHeader
                    ...
                    description="Catat distribusi zakat fitrah dan zakat maal kepada para mustahiq."
                >
                ...
                <FilterBar
                    searchPlaceholder="Cari nomor transaksi atau nama mustahiq..."
                    searchValue={search}
                ...
                <DataTable
                    ...
                    columns={
                        ...
                        ] satisfies ColumnDef<PenyaluranTransaction>[]
                    }
                    data={items}
                    isLoading={isLoading}
                    keyExtractor={(row) => row.id}
                    emptyState={<EmptyState message={search ? "Data penyaluran tidak ditemukan." : "Belum ada riwayat penyaluran zakat."} />}
                />
            ...
            <PenyaluranZakatFormPanel isOpen={isFormOpen} onClose={() => setIsFormOpen(false)} mustahiqs={rootData.mustahiqs || []} />
            <ConfirmDialog isOpen={!!confirmDeleteId} onClose={() => setConfirmDeleteId(null)} onConfirm={confirmDelete} title="Hapus Transaksi?" variant="danger">
                Apakah Anda yakin ingin menghapus catatan penyaluran ini? Tindakan ini akan menghapus transaksi kas terkait secara permanen.
            </ConfirmDialog>
        </AppLayout>
    );
}
